...
namespace volePSI_Tests
{
    ...
    oc::TestCollection Tests([](oc::TestCollection& t) {
        ...
        t.add("Psi_Rs_full_test_osn        ", Psi_Rs_full_test_osn);       // TKL
        t.add("Psi_Rs_mal_test_osn         ", Psi_Rs_mal_test_osn);       // TKL      
        t.add("Psi_Rs_partial_test_osn     ", Psi_Rs_partial_test_osn);       // TKL       
        t.add("Psi_Rs_partial_test_osnIntegrated                    ", Psi_Rs_partial_test_osnIntegrated);               // TKL
        ...
        t.add("unit_test_osn               ", unit_test_osn);
        t.add("filebase_psi_csv_osn_Test   ", filebase_psi_csv_osn_Test);
        t.add("Psi_SpHsh_test              ", Psi_SpHsh_test);
        t.add("Psi_SpHshPsiOsn_test_Integ  ", Psi_SpHshPsiOsn_test_Integrated);
        t.add("filebase_SpHshPsi_csv_osn_Test", filebase_SpHshPsi_csv_osn_Test);
        t.add("bulkdata_transfer_Test        ", bulkdata_transfer_Test);
        t.add("csvreadwrite_test             ", csvreadwrite_test);
    });
}
